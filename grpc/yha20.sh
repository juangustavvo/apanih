...
#
cd /usr/bin
wget -O add "https://raw.githubusercontent.com/juangustavvo/apanih/main/grpc/add.sh"
wget -O del "https://raw.githubusercontent.com/juangustavvo/apanih/main/grpc/del.sh"
wget -O menu "https://raw.githubusercontent.com/juangustavvo/apanih/main/grpc/menu.sh"
chmod +x menu
chmod +x add
chmod +x del
clear
